...
ДОЛЖНОСТИ (сокращения):
  ...
  комср, комсроты     — командир стрелковой роты
  ...
  замком, замкомдив   — заместитель командира (дивизии)
  замполит            — заместитель по политической части
  ПНШ, ПНШ-1..4      — помощник начальника штаба
  ...
  вет, ветфельд       — ветеринарный фельдшер
  врач, млврач        — врач, младший врач
  фельд               — фельдшер
  х                   — хозяйственная часть / завхоз
...
ПОДРАЗДЕЛЕНИЯ:
  ...
  106, 106сд          — 106-й (вспомогательное подразделение)
  164, 164осапб       — 164-й отдельный сапёрный батальон
  127                 — 127-й (подразделение)
